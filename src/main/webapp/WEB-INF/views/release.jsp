...
<span class="floatRight"><a href="/opsCenter/logout" data-toggle="tooltip" data-placement="left" title="Exit"><img src="/opsCenter/static/images/exit.png" alt="exit" height="40" width="40"></a></span>		
 	...
 	<form:form method="POST" modelAttribute="release" enctype="multipart/form-data" class="form-horizontal">
		...
		&nbsp;
 		...
 		<div class="row">
			...
			<div class="col-md-3">&nbsp;</div>
				<label class="col-md-1 control-lable" for="name"><strong>Release Name</strong></label>
				<div class="col-md-3">
...
<%-- 					<div class="has-error">
		...
		<div class="row">
			<div class="form-group col-md-12">
			<div class="col-md-3">&nbsp;</div>
				<label class="col-md-1 control-lable" for="summary"><strong>Release Summary</strong></label>
				<div class="col-md-3">
...
<%-- 					<div class="has-error">
		...
		<div class="row">
			<div class="form-group col-md-12">
			<div class="col-md-3">&nbsp;</div>
				<label class="col-md-1 control-lable" for="releasedate"><strong>Release Date</strong></label>
				<div class="col-md-3">
					<form:input path="releasedate" id="releasedate" class="form-control input-sm" disabled="${disable}"/>
<%-- 					<div class="has-error">
						<form:errors path="account" class="help-inline"/>
					</div> --%>
				</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
			<div class="col-md-3">&nbsp;</div>
				<label class="col-md-1 control-lable" for="managername"><strong>Transition Manager</strong></label>
				<div class="col-md-3">
					<form:input path="managername" id="managername" class="form-control input-sm" disabled="${disable}"/>
<%-- 					<div class="has-error">
						<form:errors path="account" class="help-inline"/>
					</div> --%>
				</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
			<div class="col-md-3">&nbsp;</div>
				<label class="col-md-1 control-lable" for="rcmleadname"><strong>RCM Lead</strong></label>
				<div class="col-md-3">
					<form:input path="rcmleadname" id="rcmleadname" class="form-control input-sm" disabled="${disable}"/>
<%-- 					<div class="has-error">
						<form:errors path="account" class="help-inline"/>
					</div> --%>
				</div>
...
<%-- 					<div class="has-error">
		...
		<div class="row">
			...
			<div class="col-md-4">&nbsp;</div>
				<c:choose>
					<c:when test="${edit}">
						<input type="submit" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/release/list' />">Cancel</a>
					</c:when>
					<c:otherwise>
						<input type="submit" value="Submit" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/release/list' />">Cancel</a>
					</c:otherwise>
				</c:choose>
			</div>
		</div><br><br><br>
		<c:choose>
			...
			<div class="col-md-3" align="left">&nbsp;</div>
				...
				<div class="col-md-3" align="left">
				<a href="" onclick="addFunction('/opsCenter/release/doc/${id}')"><img src="/opsCenter/static/images/addDoc.png"></a>
				</div>
			</div>
			<c:choose>
			<c:when test="${release.docs.size() > 0}">
							<div class="row" style="border: thin;border-color: buttontext;">
								<div class="col-md-3" align="left">&nbsp;</div>
						...
						<c:forEach items="${release.docs}" var="document" varStatus="counter">
							<div class="row" style="border: thin;border-color: buttontext;">
								<div class="col-md-3" align="left">&nbsp;</div>
