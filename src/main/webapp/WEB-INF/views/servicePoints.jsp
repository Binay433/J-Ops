	...
	<div class="generic-container1">
		<div class="panel panel-default1">
			...
			<div class="row" style="background-color: <%=System.getProperty("header_background") %>;">
		  	<div class="col-md-4" style="font-size:20;font-family: sans-serif;"><strong>Service Points List of ${userName}</strong></div>
			...
			<c:forEach items="${spList}" var="sp" varStatus="counter">
				...
				<div class="row" style="background-color:${background}">
						...
						<div class="col-md-2">
							<label><strong>${sp.created}</strong></label>
						</div>
						<div class="col-md-2">
							<label><strong>${sp.point}</strong></label>
						</div>
						<div class="col-md-3">
							<label><strong>${sp.description}</strong></label>
						</div>
				</div>
			</c:forEach>
		</div>
